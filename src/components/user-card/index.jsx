...
export default function  UserCard({ user }) {
    ...
    return (
        <button className="py-3 px-4 flex gap-3 transition-colors relative hover:bg-[color:var(--background-third)]" key={user.id}>
            ...
            <div>
                {following ? (
                    <Button size="small" variant="white-outline" onClick={() => setFollowing(false)} className="whitespace-nowrap group">

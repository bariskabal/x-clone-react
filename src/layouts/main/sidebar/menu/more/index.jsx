    ...
    return (
        <Popover className="relative text-[color:var(--color-base)]">
            ...
            <Popover.Panel className="w-[318px] absolute bottom-0 left-0 bg-[color:var(--background-primary)] shadow-box rounded-xl overflow-hidden">
                <button className="h-14 w-full inline-flex items-center gap-5 px-4 hover:bg-[color:var(--background-secondary)] transition-colors">
                    <div className="w-[26.25px] h-[26.25px] relative">
                ...
                <Disclosure>
                    {({ open} ) => (
                        <>
                            ...
                            <Disclosure.Panel>
                                <Link to="/" className="py-2 h-11 flex items-center px-3 gap-3 text-[15px] font-medium w-full hover:bg-[color:var(--background-secondary)] transition-colors">
                                    <svg viewBox="0 0 24 24" width={26.25} height={26.25} className="block">
                                        <path
                                        fill="currentColor"
                    ...
                    {({open}) => (
                        ...
                        <Disclosure.Button className="py-2 h-[52px] flex items-center px-4 font-bold justify-between w-full hover:bg-[color:var(--background-secondary)] transition-colors">
                            ...
                            <Disclosure.Panel>
                                ...
                                <button onClick={() => setModal('appearance')} className="py-2 h-11 flex items-center px-3 gap-3 text-[15px] font-medium w-full hover:bg-[color:var(--background-secondary)] transition-colors">
                                    <svg viewBox="0 0 24 24" width={26.25} height={26.25} className="block">
                                        <path
                                        fill="currentColor"
